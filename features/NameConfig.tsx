      ...
      <div className="space-y-6">
        <div className="grid grid-cols-2 gap-4">
          <button 
            ...
            className={`p-6 rounded-2xl flex flex-col items-center space-y-2 border-2 transition-all ${type === 'RANKING' ? 'border-[#ff4500] bg-orange-50 text-[#ff4500]' : 'border-gray-100 bg-gray-50 text-gray-400'}`}
          >
          ...
          <button 
            ...
            className={`p-6 rounded-2xl flex flex-col items-center space-y-2 border-2 transition-all ${type === 'CELEBRITY' ? 'border-[#ff4500] bg-orange-50 text-[#ff4500]' : 'border-gray-100 bg-gray-50 text-gray-400'}`}
          >
